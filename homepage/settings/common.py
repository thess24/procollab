...
# Django settings for bussim project.
...
SECRET_KEY = '#*615sdf)hasdfh(&HIkhljhkljasdfljk&&c9mvpoqzz265tsogi'
...
PAYMENTS_PLANS = {
    "monthly": {
        ...
        "name": "TwitPull Pro ($20/month)",
        "description": "The monthly subscription plan to TwitPull",
        "price": 20,
        "currency": 'usd',
        "interval": "month"
    },
    "yearly": {
        ...
        "description": "The annual subscription plan to TwitPull",
        "price": 199,
        "currency": 'usd',
        "interval": "year"
    },
